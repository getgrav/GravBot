    ...
    return _asyncToGenerator(_regeneratorRuntime.mark(function _callee() {
      ...
      return _regeneratorRuntime.wrap(function (_context) {
        for (;;) switch (_context.prev = _context.next) {
          ...
          case 6:
            return _ref = _context.sent, data = _ref.data, _context.abrupt("return", kitsuCore.deserialise(data));

          case 11:
            throw _context.prev = 11, _context.t0 = _context["catch"](1), kitsuCore.error(_context.t0);
    ...
    return _asyncToGenerator(_regeneratorRuntime.mark(function _callee2() {
      ...
      return _regeneratorRuntime.wrap(function (_context2) {
        for (;;) switch (_context2.prev = _context2.next) {
          case 0:
            return headers = 2 < _arguments2.length && void 0 !== _arguments2[2] ? _arguments2[2] : {}, _context2.prev = 1, _context2.next = 4, kitsuCore.serialise.apply(_this2, [model, body, 'PATCH']);
          ...
          case 13:
            throw _context2.prev = 13, _context2.t0 = _context2["catch"](1), kitsuCore.error(_context2.t0);
    ...
    return _asyncToGenerator(_regeneratorRuntime.mark(function _callee3() {
      ...
      return _regeneratorRuntime.wrap(function (_context3) {
        for (;;) switch (_context3.prev = _context3.next) {
          case 0:
            return headers = 2 < _arguments3.length && void 0 !== _arguments3[2] ? _arguments3[2] : {}, _context3.prev = 1, url = _this3.plural(_this3.resCase(model)), _context3.t0 = _this3.axios, _context3.t1 = url, _context3.next = 7, kitsuCore.serialise.apply(_this3, [model, body]);
          ...
          case 16:
            throw _context3.prev = 16, _context3.t4 = _context3["catch"](1), kitsuCore.error(_context3.t4);
    ...
    return _asyncToGenerator(_regeneratorRuntime.mark(function _callee4() {
      ...
      return _regeneratorRuntime.wrap(function (_context4) {
        for (;;) switch (_context4.prev = _context4.next) {
          case 0:
            return headers = 2 < _arguments4.length && void 0 !== _arguments4[2] ? _arguments4[2] : {}, _context4.prev = 1, url = _this4.plural(_this4.resCase(model)) + '/' + id, _context4.t0 = _this4.axios, _context4.t1 = url, _context4.next = 7, kitsuCore.serialise.apply(_this4, [model, {
              id
            }, 'DELETE']);
          ...
          case 17:
            throw _context4.prev = 17, _context4.t5 = _context4["catch"](1), kitsuCore.error(_context4.t5);
    ...
    return _asyncToGenerator(_regeneratorRuntime.mark(function _callee5() {
      ...
      return _regeneratorRuntime.wrap(function (_context5) {
        for (;;) switch (_context5.prev = _context5.next) {
          ...
          case 8:
            throw _context5.prev = 8, _context5.t0 = _context5["catch"](1), kitsuCore.error(_context5.t0);
